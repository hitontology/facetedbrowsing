(function () {
  ...
  /* @ngInject */
  function MainController($scope, FacetHandler, softwareProductService, facetUrlStateHandlerService) {
    var vm = this;
    ...
    // Get the facet configurations from softwareProductService.
    vm.facets = softwareProductService.getFacets();
    ...
    function getFacetOptions() {
      var options = softwareProductService.getFacetOptions();
      options.scope = $scope;
    ...
    function updateResults(event, facetSelections) {
      ...
      // The softwareProductService returns a (promise of a) pager object.
      return softwareProductService.getResults(facetSelections).then(function (pager) {
        if (uid === updateId) {
          vm.pager = pager;
